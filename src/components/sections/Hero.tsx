  ...
  return (
    <>
      ...
      >
        {target}
        {/*
         * Comic-style click sound effect. Hand-lettered "click!"
         * text floats above the word on every click / autoflip --
         * the way comics depict the audible snap of a camera
         * shutter or button press. Permanent Marker font (loaded
         * in layout.tsx, ~10kb, used only here). Slight rotation
         * keeps it hand-drawn rather than computery.
         */}
        <span className="hero-rec-pill__sfx" aria-hidden="true">
          click!
        </span>
      </span>
      {after}
